...
function Login() {
  ...
  const[customerid,setCustomerId]=useState(SearchParam.get("customerid"));
  ...
  //............
  // Replace this mock authentication with your actual authentication logic
        ...
        .then((data) => {
          ...
          if (!userMatch) {
            ...
            if (password === storedPassword) {
              ...
              window.location.href=`/ItemsDisplay?customerid=${customerid}`;
        ...
        <div className="row mx-auto mt-5">
          <div className="mx-auto col-md-6 mt-5 pt-4">
            <div className="card mb-5 p-2 shadow rounded">
              ...
              <div class="row mt-3">
                        <div class="col-sm-3"><a href="/AdminLogin" class="text-decoration-none mb-3 text-success fw-bold ">Admin?</a></div>
              ...
              {message && (
               ...
               <div><Link component='a' to={`/AfterLogin?email=${email}&password=${password}`}>See Your Details</Link></div>
            </form>
          </div>
        </div>
      </div>
