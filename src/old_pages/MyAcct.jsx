...
const UserProfile = () => {
  ...
  return (
    <Lay>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '70vh', color: 'white', background: 'linear-gradient(lightaqua, black)' }}>
        <center>
          <div className="customer-card">
            <Card style={{backgroundImage: `url(${img})`,backgroundSize: 'cover',backgroundRepeat: 'no-repeat',width:'700px',height: '400px'}}>
              <CardContent style={{ textAlign: 'center', width: '400px', height: '250px' }}>
                {userProfile ? (
                  <>
